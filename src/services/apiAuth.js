...
export async function signup(formData) {
  ...
  try {
    const response = await axios.post(
      'http://13.209.35.28:3000/api/v1/auth/signup',
      {
        ...formData,
      },
    )
...
export async function sendCode({ email, type }) {
  try {
    const response = await axios.post(
      'http://13.209.35.28:3000/api/v1/auth/send-code',
      {
        email,
        type,
      },
...
export async function checkCode({ email, code }) {
  try {
    const response = await axios.get(
      `http://13.209.35.28:3000/api/v1/auth/auth-code?email=${email}&code=${code}`,
    )
...
export async function checkNickname({ nickname }) {
  try {
    const response = await axios.get(
      `http://13.209.35.28:3000/api/v1/users/check-nickname?nickname=${nickname}`,
    )
...
export async function login({ email, password }) {
  try {
    const response = await axios.post(
      'http://13.209.35.28:3000/api/v1/auth/login',
      {
        email,
        password,
      },
